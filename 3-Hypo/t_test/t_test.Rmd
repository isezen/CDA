...
output:
  beamer_presentation:
    template: ../../template/default.beamer
    keep_tex: yes
    slide_level: 3
    fig_caption: yes
    theme: CambridgeUS
    colortheme: euresia
    highlight: tango
    pandoc_args: ["--listings", "-H", "../../template/listings-setup.tex"]
    # pandoc_args: ["--highlight-style", "../../template/mystyle.theme"]
    includes:
...
\addplot{0.5}{t_test_files/figure-beamer/fig3_t_quantiles-1}
...
\addplot{0.5}{t_test_files/figure-beamer/fig4_conf_int-1}
